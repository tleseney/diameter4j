...
public class Cx {
     ...
     * </pre>
     */
    public static final Command UAR = IMS.newRequest(UAR_ORDINAL,
     ...
     * </pre>
     */
    public static final Command UAA = IMS.newAnswer(UAA_ORDINAL,
     ...
     * 		*[ Route-Record ]
     */
    public static final Command SAR = IMS.newRequest(SAR_ORDINAL,
     ...
     * </pre>
     */
    public static final Command SAA = IMS.newAnswer(SAA_ORDINAL,
     ...
     * </pre>
     */
    public static final Command LIR = IMS.newRequest(LIR_ORDINAL,
     ...
     * </pre>
     */
    public static final Command LIA = IMS.newAnswer(LIA_ORDINAL,
     ...
     * </pre>
     */
    public static final Command MAR = IMS.newRequest(MAR_ORDINAL,
     ...
     * </pre>
     */
    public static final Command MAA = IMS.newAnswer(MAA_ORDINAL,
     ...
     * </pre>
     */
    public static final Command RTR = IMS.newRequest(RTR_ORDINAL,
     ...
     * </pre>
     */
    public static final Command RTA = IMS.newAnswer(RTA_ORDINAL,
     ...
     * </pre>
     */
    public static final Command PPR = IMS.newRequest(PPR_ORDINAL,
            "Multimedia-Auth-Request");
     ...
     * </pre>
     */
    public static final Command PPA = IMS.newAnswer(PPA_ORDINAL,
            " Multimedia-Auth-Answer");
    ...
    public static final int
            ...
            ORIGINATING_REQUEST_ORDINAL = 633,
    ...
    public static final Type<byte[]> VISITED_NETWORK_IDENTIFIER = IMS.newIMSType("Visited-Network-Identifier",
            VISITED_NETWORK_IDENTIFIER_ORDINAL, Common.octetString);
    ...
    public static final Type<AVPList> SUPPORTED_FEATURES = IMS.newIMSType("Supported-Features",
            SUPPORTED_FEATURES_ORDINAL, Common.grouped);
    ...
    public static final Type<AVPList> SERVER_CAPABILITIES = IMS.newIMSType("Server-Capabilities",
            SERVER_CAPABILITIES_ORDINAL, Common.grouped);
     ...
     */
    public static final Type<Long> MANDATORY_CAPABILITIES = IMS.newIMSType("Mandatory-Capability",
            MANDATORY_CAPABILITIES_ORDINAL, Common.unsigned32);
     ...
     * of these values to individual capabilities is an operator issue.
     */
    public static final Type<Long> OPTIONAL_CAPABILITIES = IMS.newIMSType("Optional-Capability",
            OPTIONAL_CAPABILITY_ORDINAL, Common.unsigned32);
     ...
     */
    public static final Type<Long> SIP_NUMBER_AUTH_ITEMS = IMS.newIMSType("SIP-Number-Auth-Items",
            SIP_NUMBER_AUTH_ITEMS_ORDINAL, Common.unsigned32);
    ...
    public static final Type<String> SIP_AUTHENTICATION_SCHEME = IMS.newIMSType("Authentication-Scheme",
            SIP_AUTHENTICATION_SCHEME_ORDINAL, Common.utf8String);
    ...
    public static final Type<byte[]> SIP_AUTHENTICATE = IMS.newIMSType("SIP-Authenticate",
            SIP_AUTHENTICATE_ORDINAL, Common.octetString);
    ...
    public static final Type<byte[]> SIP_AUTHORIZATION = IMS.newIMSType("SIP-Authorization",
            SIP_AUTHORIZATION_ORDINAL, Common.octetString);
    ...
    public static final Type<byte[]> SIP_AUTHENTICATION_CONTEXT = IMS.newIMSType("SIP-Authentication-Context",
            SIP_AUTHENTICATION_CONTEXT_ORDINAL, Common.octetString);
    ...
    public static final Type<AVPList> SIP_AUTH_DATA_ITEM = IMS.newIMSType("SIP-Auth-Data-Item",
            SIP_AUTH_DATA_ITEM_ORDINAL, Common.grouped);
     ...
     */
    public static final Type<Long> SIP_ITEM_NUMBER = IMS.newIMSType("SIP-Item-Number",
            SIP_ITEM_NUMBER_ORDINAL, Common.unsigned32);
    ...
    public static final Type<ServerAssignmentType> SERVER_ASSIGNMENT_TYPE = IMS.newIMSType(
            "Server-Assignment-Type", SERVER_ASSIGNMENT_TYPE_ORDINAL,
            new Common.EnumDataFormat<ServerAssignmentType>(ServerAssignmentType.class));
    ...
    public static final Type<AVPList> DERISTRATION_REASON = IMS.newIMSType("Deregistration-Reason",
            DERISTRATION_REASON_ORDINAL, Common.grouped);
    ...
    public static final Type<ReasonCode> REASON_CODE = IMS.newIMSType("Reason-Code",
            REASON_CODE_ORDINAL, new Common.EnumDataFormat<ReasonCode>(ReasonCode.class));
    ...
    public static final Type<String> REASON_INFO = IMS.newIMSType("Reason-Info",
            REASON_INFO_ORDINAL, Common.utf8String);
    ...
    public static final Type<UserAuthorizationType> USER_AUTHORIZATION_TYPE = IMS.newIMSType("User-Authorization-Type",
            USER_AUTHORIZATION_TYPE_ORDINAL, new Common.EnumDataFormat<UserAuthorizationType>(UserAuthorizationType.class));
    ...
    public static final Type<UserDataAlreadyAvailable> USER_DATA_ALREADY_AVAILABLE = IMS.newIMSType(
            "User-Data-Already-Available", USER_DATA_ALREADY_AVAILABLE_ORDINAL,
            new Common.EnumDataFormat<UserDataAlreadyAvailable>(UserDataAlreadyAvailable.class));
    ...
    public static final Type<byte[]> CONFIDENTIALITY_KEY = IMS.newIMSType("Confidentiality-Key",
            CONFIDENTIALITY_KEY_ORDINAL, Common.octetString);
    ...
    public static final Type<byte[]> INTEGRITY_KEY = IMS.newIMSType("Integrity-Key",
            INTEGRITY_KEY_ORDINAL, Common.octetString);
    ...
    public static final Type<AVPList> ASSOCIATED_IDENTITIES = IMS.newIMSType("Associated-Identities",
            ASSOCIATED_IDENTITIES_ORDINAL, Common.grouped).notMandatory();
     ...
     */
    public static final Type<OriginatingRequest> ORIGINATING_REQUEST = IMS.newIMSType("Originating-Request",
            ORIGINATING_REQUEST_ORDINAL,
            new Common.EnumDataFormat<OriginatingRequest>(OriginatingRequest.class));
    ...
    public static final Type<AVPList> SIP_DIGEST_AUTHENTICATE = IMS.newIMSType("SIP-Digest-Authenticate",
            SIP_DIGEST_AUTHENTICATE_ORDINAL, Common.grouped).notMandatory();
    ...
    public static final Type<String> WILCARDED_PSI = IMS.newIMSType("Wildcarded-PSI",
            WILCARDED_PSI_ORDINAL, Common.utf8String).notMandatory();
    ...
    public static final Type<String> PUBLIC_IDENTITY = IMS.newIMSType("Public-Identity",
            PUBLIC_IDENTITY_ORDINAL, Common.utf8String);
    ...
    public static final Type<String> WILCARDED_IMPU = IMS.newIMSType("Wildcarded-IMPU",
            WILCARDED_IMPU_ORDINAL, Common.utf8String).notMandatory();
     ...
     */
    public static final Type<Long> UAR_FLAGS = IMS.newIMSType("UAR-Flags",
            UAR_FLAGS_ORDINAL, Common.unsigned32).notMandatory();
    ...
    public static final Type<String> SERVER_NAME = IMS.newIMSType("Server-Name",
            SERVER_NAME_ORDINAL, Common.utf8String);
